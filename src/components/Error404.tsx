    ...
    <div className="min-h-screen bg-gray-950 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-8 py-16">
        <div className="max-w-xl w-full text-center">
          ...
          {/* Icon */}
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-amber-900/30 border border-amber-800/50 mb-6 -mt-16 relative z-10 rise-in-1 animate-icon-glow">
            <AlertTriangle size={32} className="text-amber-400 animate-wiggle" />
          </div>
