    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8 py-8 sm:py-16">
        <div className="max-w-xl w-full text-center">
          ...
          {/* Big code */}
          <div className="text-[96px] sm:text-[180px] font-black leading-none text-red-500 opacity-10 select-none">
            500
          </div>
          ...
          {/* Status card */}
          <div className="inline-flex items-start gap-3 sm:gap-4 bg-white border border-gray-200 rounded-2xl px-4 sm:px-6 py-5 text-left max-w-sm w-full">
